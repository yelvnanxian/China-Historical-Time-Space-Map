...
mountain_regions_path = ROOT/'public/data/physical-regions.geojson'
if mountain_regions_path.exists():
    mountain_regions = json.loads(mountain_regions_path.read_text())
