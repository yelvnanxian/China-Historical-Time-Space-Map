...
const steps = [
  ...
  { anchor: "map-canvas", title: "放大地图，逐级看辖区", body: "层级自动随缩放从已有国家、省道切换到府州、县域和城池。点行政名称或区域可高亮辖区，搜索后仍自动分级。755年的“郡”比县高一级，按州级显示；选中已关联的州郡会框出完整741年参考辖区；缺少依据的地区会提示，县域不等于城墙范围。" },
  ...
  { anchor: "map-tools", title: "放大看河湖与山脊", body: "地图工具中展开“细节区域与来源”，可进入关中、江南、河西、新疆绿洲等采集区；8级起看主河，10—12级逐步显示支流和小水面。“山地近览·看山形”可进入华山、终南山、天山、川西等17处峰顶周边，观察真实等高线和坡面；点山峰可自动近览，点棕色山脊线查看来源。这些均为有缺口的现代参照。" },
